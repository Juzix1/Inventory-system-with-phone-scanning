...
namespace InventoryAPI.Migrations
{
    ...
    [Migration("20260130135420_SeperateCheckedItemsInStocktake")]
    partial class SeperateCheckedItemsInStocktake
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InventoryLibrary.Model.StockTake.StocktakeCheckedItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("StocktakeCheckedItems", (string)null);
                });
            ...
            modelBuilder.Entity("InventoryWeb.Models.Setting", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 4,
                            Key = "ChosenDepartmentId",
                            Value = ""
                        });
                });

            modelBuilder.Entity("StocktakeAuthorizedAccounts", b =>
                {
                    ...
                    b.HasKey("AccountId", "StocktakeId");

                    b.HasIndex("StocktakeId");

                    b.ToTable("StocktakeAuthorizedAccounts");
                });
            ...
            modelBuilder.Entity("StocktakeAuthorizedAccounts", b =>
                {
                    b.HasOne("InventoryLibrary.Model.Accounts.Account", null)
                        .WithMany()
